...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO livraisons (commande_id, transporteur, num_suivi, date_expedition, status) 
            VALUES (:commande_id, :transporteur, :num_suivi, :date_expedition, 'En cours')";
...
<head>
    ...
    <title>Enregistrer Livraison</title>
...
<h1 class="mot">Enregistrer Livraison</h1>
<center>
<div class="form-livraison">
    <form action="" method="post">
        <input type="hidden" name="commande_id" value="<?php echo htmlspecialchars($commande_id); ?>">
        <label for="transporteur">Transporteur :</label>
        <input type="text" id="transporteur" name="transporteur" required>
        <label for="num_suivi">Numéro de Suivi :</label>
        <input type="text" id="num_suivi" name="num_suivi" required>
